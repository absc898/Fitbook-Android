...
class DetailedWeightActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startDate.text = intent.getStringExtra("startTime")
        ...
        deleteWorkout.setOnClickListener{
            val request = DataDeleteRequest.Builder()
                .setTimeInterval(intent.getStringExtra("startTimeMill")!!.toLong(), intent.getStringExtra("endTime")!!.toLong(), TimeUnit.MILLISECONDS)
